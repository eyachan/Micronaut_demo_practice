...
public class InMemoryBookControllerTest {


    private final BookController bookController;

    public InMemoryBookControllerTest() {
        this.bookController = new BookController(new BookService(new InMemoryRepository()));
    }
  ...
  /*  @Test
    ...
    public void save_collection_valid_books_input_and_expect_list_of_books() {
        ...
        Assertions.assertAll(
                ...
                .stream()
                        .map(BookController.BookSwap::toBook)
                        .collect(Collectors.toUnmodifiableList())
                ),
  ...
  /*  @Test
    ...
    public void delete_book_by_id_expect_deleted_book() {
        ...
        Assertions.assertEquals(HttpStatus.OK, delete.getStatus());
    }
    ...
    public void delete_all_book_collection_expect_empty_list() {
        ...
        Assertions.assertEquals(HttpStatus.OK, stringHttpResponse.getStatus());
    }
