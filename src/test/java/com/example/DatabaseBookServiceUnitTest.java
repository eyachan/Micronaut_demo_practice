...
@MicronautTest
public class DatabaseBookServiceUnitTest {

    private final BookService bookService ;

    public DatabaseBookServiceUnitTest(BookDtoRepository bookDtoRepository) {
        final var bookrepository = new DatabaseRepository(bookDtoRepository) ;
